    ...
    <div class="tbl_head01 tbl_wrap">
        <table>
            ...
            <tbody>
				...
				//=============================================================================              
                if($mb['mb_level'] == '10') {
                  $mb_adm_levelname = '<span class="red">' . $config['lev_cf_10'] . '</span>';
                } else if($mb['mb_level'] == '9') {
                  $mb_adm_levelname = '<span class="red">' . $config['lev_cf_9'] . '</span>';
                } else if($mb['mb_level'] == '8') {
                  $mb_adm_levelname = '<span class="red">' . $config['lev_cf_8'] . '</span>';
                } else if($mb['mb_level'] == '7') {
                  $mb_adm_levelname = '<span class="red">' . $config['lev_cf_7'] . '</span>';
                } else if($mb['mb_level'] == '6') {
                  $mb_adm_levelname = '<span class="red">' . $config['lev_cf_6'] . '</span>';
                } else if($mb['mb_level'] == '5') {
                  $mb_adm_levelname = '<span class="red">' . $config['lev_cf_5'] . '</span>';
                } else if($mb['mb_level'] == '4') {
                  $mb_adm_levelname = '<span class="red">' . $config['lev_cf_4'] . '</span>';
                } else if($mb['mb_level'] == '3') {
                  $mb_adm_levelname = '<span class="red">' . $config['lev_cf_3'] . '</span>';
                } else if($mb['mb_level'] == '2') {
                  $mb_adm_levelname = '<span class="red">' . $config['lev_cf_2'] . '</span>';
                } else if($mb['mb_level'] == '1') {
                  $mb_adm_levelname = '<span class="red">' . $config['lev_cf_1'] . '</span>';
                } else if($mb['mb_level'] == '0') {
                  $mb_adm_levelname = '<span class="red">' . $config['lev_cf_0'] . '</span>';
                }
                ?>
                    ...
                    <tr class="<?php echo $bg; ?>">
                        ...
                        <td headers="mb_list_id" colspan="2" class="td_name sv_use">
                            <?php echo $mb_adm_levelname; //회원레벨 한글로 표시?> <?php echo $mb_id ?>
                            <?php
                            //소셜계정이 있다면
